<form action="/assignedWorkOrders">
    <div class="relative m-4 rounded-lg max-w-xs mx-auto mb-5" style="display:flex;">
    <x-text-input
    type="text"
    name="search"
    title="Search by description, date(2022-11-28) or work order number"
    class="h-10 w-8/12 pl-10 pr-20 text-black rounded-md z-0 focus:shadow focus:outline-none border border-stone-600"
    placeholder="Search..."
    style="flex:1;"/>
